...
Based on these findings, the research focus shifts slightly. Instead of only asking whether regime shifts are associated with changes in the ratio, the analysis now considers more specific questions: 
